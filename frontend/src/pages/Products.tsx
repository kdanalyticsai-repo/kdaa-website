...
const PRODUCTS = [
  {
    ...
    capabilities: [
      ...
      'AI Career Coach, interview prep, and cover letter generation',
      'Resume upload, ATS scoring, and tailoring for specific roles',
      'Job provider portal — post listings, manage applicants, and track hiring',
    ],
  ...
  },
  {
    ...
    capabilities: [
      ...
      'Sangha community + a fully multilingual experience (EN / HI / TA / BN / GU / OR)',
    ],
