...
@router.get("/api/proaicv/subscribe", response_class=HTMLResponse, include_in_schema=False)
async def proaicv_subscribe():
    """Razorpay checkout page for ProAICV Pro upgrades."""
    return """<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>ProAICV Pro – Upgrade</title>
...
<div class="card">
  <div id="payment-view">
    ...
    <p class="note">
      ...
      After payment, return to the ProAICV app and pull down to refresh your profile.
    </p>
  </div>
  <div id="success">
    <div class="icon">🎉</div>
    ...
    <p>
      Your ProAICV account has been upgraded to Pro.<br><br>
...
@router.get("/api/cvproai/subscribe", response_class=RedirectResponse, include_in_schema=False)
async def cvproai_subscribe_redirect():
    """Backward-compat redirect from old CVProAI subscribe URL."""
    return RedirectResponse(url="/api/proaicv/subscribe", status_code=301)
